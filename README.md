...
[`data_util.py`](https://github.com/dom-schulz/machine-learning-algorithms/blob/main/data_util.py)
...
[`data_learn.py`](https://github.com/dom-schulz/machine-learning-algorithms/blob/main/data_learn.py)
...
[`data_eval.py`](https://github.com/dom-schulz/machine-learning-algorithms/blob/main/data_eval.py)
...
[`decision_tree.py`](https://github.com/dom-schulz/machine-learning-algorithms/blob/main/decision_tree.py)
